...
FOMSI (FOrest Model SImulator) is deterministic model to simulate forest population
...
note: 
     Published Table 3 say "mean weigthed C in the system" where have to say "mean weigthed total woody C storage", because herbaceous layer is not accounted. That is important because you should expect bigger herbaceus C storage in disturbed systems, wich at least could balance a little disturbance.   
